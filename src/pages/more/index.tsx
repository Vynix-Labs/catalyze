  ...
  const menuItems: MenuItem[] = [
    {
      ...
      onClick: () => handleNavigation("gamification", RoutePath.GAMIFICATION),
    },
    {
      id: "history",
      title: "History",
      ...
      onClick: () => handleNavigation("history", RoutePath.HISTORY),
    },
    {
      id: "learning-hub",
      title: "Learning Hub",
      description: "Lorem ipsum dolor sit amet consectetur.",
      icon: <VideoIcon className="h-6 w-6" />,
      onClick: () => handleNavigation("learning-hub", RoutePath.LEARNING_HUB),
    },
    {
      id: "staking",
      title: "Staking",
