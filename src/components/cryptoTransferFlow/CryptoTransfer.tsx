      ...
      <div className="mb-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full p-3 border border-gray-200 rounded-lg text-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
          />
        </div>
      </div>
